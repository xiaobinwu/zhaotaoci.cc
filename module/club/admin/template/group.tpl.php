...
<?php } else { ?>
<td class="px11"><a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&gid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 帖子管理');"><?php echo $v['post'];?></a></td>
<td class="px11"><a href="javascript:Dwidget('?moduleid=<?php echo $moduleid;?>&file=fans&gid=<?php echo $v['itemid'];?>', '[<?php echo $v['alt'];?>] 粉丝管理');"><?php echo $v['fans'];?></a></td>
<td>
